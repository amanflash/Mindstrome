...
if(isset($_GET['delete'])){
  ...
  $delete_query = mysqli_query($conn, "DELETE FROM `subscriber` WHERE id = $delete_id ") or die('query failed');
  if($delete_query){
            ...
            <div class="table-responsive">
              <table class="table table-dark">
                ...
                <tbody>
                  ...
                  $select_products = mysqli_query($conn, "SELECT * FROM `subscriber`");
                  ...
                  ?>
                      <tr>
                        ...
                        <td><a href="index.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a></td>
                      </tr>
                  <?php
                    };
                  } else {
